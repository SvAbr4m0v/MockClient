package lwm2mjmeter.jmeter.protocol.lwm2m;
...
public class LwM2mManagerBeanInfo extends BeanInfoSupport {
    ...
    public LwM2mManagerBeanInfo() {
        ...
        new String[]{"serverURI", "registrationPath", "registrationDuration", "updateRate", "registerAtStart", "derregisterAtStop"});
        ...
        p = property("updateRate");
        p.setValue(NOT_UNDEFINED, Boolean.TRUE);
        p.setValue(DEFAULT, 10L);

        p = property("registrationDuration");
        p.setValue(NOT_UNDEFINED, Boolean.TRUE);
        p.setValue(DEFAULT, 86400L);
